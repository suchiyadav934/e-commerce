        ...
        <div className="card mb-3" style={{borderRadius: '.5rem'}}>
          <div className="row g-0">
            <div className="col-md-4 gradient-custom text-center text-white" style={{borderTopLeftRadius: '.5rem', borderBottomLeftRadius: '.5rem'}}>
              ...
              <h5 className='text-dark'>Full Stack Web Developer</h5>
              <p className='text-dark'> MERN DEVELOPER</p>
              ...
              <div className="card-body p-4">
                ...
                <div className="row pt-1">
                  <div className="col-6 mb-3">
                    <h6>Email</h6>
                    <p className="text-muted">suchiTech934@example.com</p>
                  </div>
                  <div className="col-6 mb-3">
                    <h6>Phone</h6>
                    <p className="text-muted">+91-6382848225</p>
                  </div>
                </div>
                <h6>Projects</h6>
                <hr className="mt-0 mb-4" />
                <div className="row pt-1">
                  <div className="col-6 mb-3">
                    <h6>Project</h6>
                    <p className="text-muted">E-Commerce site</p>
                  </div>
                  <div className="col-6 mb-3">
                    <h6>Most Viewed</h6>
                    <p className="text-muted">e-comsite</p>
                  </div>
                </div>
                <div className="d-flex justify-content-start text-dark bg-dark">
